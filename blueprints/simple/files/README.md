...
<%= name %> is LeanES application for <description>
...
* [LeanES CLI](https://leanes-cli.com/)
...
Make use of the many generators for code, try `leanes help generate` for more details
