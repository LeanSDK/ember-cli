...
const INVALID_PROJECT_NAMES = ['test', 'leanes', 'leanes-cli', 'vendor', 'public', 'app', 'addon', 'application'];
 ...
 *
 * Invalid names are some of the internal constants that LeanES CLI uses, such as
 * `app`, `leanes`, `leanes-cli`, `test`, and `vendor`. Names that start with
 * numbers are considered invalid as well.
 *
 * @method validProjectName
 * @param {String} name The name of LeanES CLI project
 * @return {Boolean}
 */
