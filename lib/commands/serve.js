...
module.exports = Command.extend({
  ...
  availableOptions: [
    ...
    { name: 'live-reload-port', type: Number, aliases: ['lrp'], description: 'Defaults to same port as leanes app' },
    ...
    { name: 'output-path', type: 'Path', default: 'dist/', aliases: ['op', 'out'] },
    {
      ...
      type: Boolean,
      default: false,
      description: 'Set to true to configure LeanES CLI to serve using SSL.',
    },
    {
      name: 'ssl-key',
      type: String,
